function [homologous_zones_for_k] = find_homologous_zones_in(k, sequence_1, sequence_2, sequence_1_index, sequence_2_index, windows_size)
    k
    sequence_1_index
    sequence_2_index
    ...
    for window_index = 1 : number_of_windows
        ...
        homologous_zones_for_k(window_index, 5) = sum_of_pairs(sequence_1.Sequence, sequence_2.Sequence, sum_of_pairs_index.start, sum_of_pairs_index.end);
    end
    homologous_zones_for_k
end
